...
CREATE TABLE [Flood].[FloodParcelTech](
	...
	[FEMACommunityId]                                   [integer]									NULL	,
	[FirmEffectiveDate]                                 [DateTime]									NULL	,
	[FirmPanel]                                         [varchar]									NULL	,
	[FirmPanelFinal]                                    [varchar]									NULL	,
	[FloodZoneDesignation]                              [varchar]									NULL	,
	...
	[FloodProfile]                                      [varchar]									NULL	,
	[FloodProfileFinal]                                 [varchar]									NULL	,
	[FloodSource]                                       [varchar]									NULL	,
