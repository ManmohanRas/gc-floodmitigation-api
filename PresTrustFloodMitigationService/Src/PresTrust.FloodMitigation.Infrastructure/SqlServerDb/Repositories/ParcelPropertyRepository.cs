...
/// <returns></returns>
public async Task<FloodParcelPropertyEntity> SavePropertyAsync(FloodParcelPropertyEntity floodParcelPropertyDetails)
{
...
private async Task<FloodParcelPropertyEntity> SaveAsync(FloodParcelPropertyEntity floodParcelPropertyDetails)
{
    ...
    var id = await conn.ExecuteScalarAsync<int>(sqlCommand.ToString(),
        ...
        param: new
        {
            ...
            @p_TotalAssessedValue = floodParcelPropertyDetails.TotalAssessedValue,
            @p_LandValue = floodParcelPropertyDetails.LandValue,
            @p_ImprovementValue = floodParcelPropertyDetails.ImprovementValue,
            @p_AnnualTaxes = floodParcelPropertyDetails.AnnualTaxes,
