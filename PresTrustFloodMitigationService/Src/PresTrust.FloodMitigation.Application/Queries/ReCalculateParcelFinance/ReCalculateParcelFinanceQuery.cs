...
public class ReCalculateParcelFinanceQuery: IRequest<ReCalculateParcelFinanceQueryViewModel>
{
    ...
    public decimal HardCostFMPAmtReimbursed { get; set; }
    ...
    public decimal SoftCostFMPAmtReimbursed { get; set; }
