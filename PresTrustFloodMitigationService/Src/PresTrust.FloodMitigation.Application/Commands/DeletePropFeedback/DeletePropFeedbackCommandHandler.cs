...
public class DeletePropFeedbackCommandHandler : BaseHandler, IRequestHandler<DeletePropFeedbackCommand, bool>
{
    ...
    public DeletePropFeedbackCommandHandler
    (
        IMapper mapper,
    ...
    /// <returns></returns>
    public async Task<bool> Handle(DeletePropFeedbackCommand request, CancellationToken cancellationToken)
    {
        ...
        var reqFeedback = mapper.Map<DeletePropFeedbackCommand, FloodPropertyFeedbackEntity>(request);

        // delete feedback
        await repoFeedback.DeletePropFeedbackAsync(reqFeedback);
        return true;
    }
